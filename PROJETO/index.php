        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    ...
                    <h3 class="title has-text-black"><a href="index.html" target="_blank">Razor</a></h3>   
                    <?php
                    ...
                    <div class="box">
                        ...
                        <button type="submit" class="button is-block is-link is-large is-fullwidth">Cadastro</button>
                        </form>
